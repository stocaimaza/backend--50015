...
const connection = mongoose.connect(`tubd`).then(() => console.log("Conectados a la BD"))
...
//swagger-jsdoc: nos deja escribir la configuación en un archivo .yaml (tambien json) y a partir de ahi se genera un apidoc. 
